        ...
        <table class="table table-dark table-striped">
            ...
            @foreach($Company as $Company)
                <tr>
                    ...
                    <td>{{$Company->Email}}</td>
                    <td>{{$Company->Phone}}</td>
                    <td><a href="{{url('Count',$Company->id)}}" class="btn btn-success">Count</a>
                    </td>
                    <td> <a href="{{url('EditCom',$Company->id)}}" class="btn btn-success">Edit</a>
                        <a href="{{url('DeleteCom',$Company->id)}}" class="btn btn-danger">Delete</a>
                    </td>
                </tr>
            @endforeach
            </tbody>
